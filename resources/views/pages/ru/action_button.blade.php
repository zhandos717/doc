...
<x-p>
    Метод <code>badge()</code> позволяет добавить значок в кнопку.
</x-p>
...
Некоторые исключить можно через параметр <code>exclude</code>:
...
Также можно полностью исключить отправку <code>withoutPayload</code>:
