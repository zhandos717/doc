...
В данном рецепты мы покажем как кастомизировать страницу с формой (взяли пример статей из основного демо репозитория), где вынесем поля отношений в отдельные вкладки, 
